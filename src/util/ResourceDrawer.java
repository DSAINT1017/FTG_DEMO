...
public class ResourceDrawer {
	...
	private void drawEnergyGaugeImage(Character[] playerCharacters) {
		if (FlagSetting.limitHpFlag) {
			...
			GraphicManager.getInstance().drawString("P1 ENERGY:" + playerCharacters[0].getEnergy(), 100, 80);
			GraphicManager.getInstance().drawString("P2 ENERGY:" + playerCharacters[1].getEnergy(), 760, 80);
			GraphicManager.getInstance().drawString("P1 END:" + playerCharacters[0].getEndurance(), 100, 110);
			GraphicManager.getInstance().drawString("P2 END:" + playerCharacters[1].getEndurance(), 760, 110);
		}
	}
